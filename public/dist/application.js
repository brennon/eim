...
/**
 * In the demo application, the `ImpulsePlaybackController` is responsible for
 * initiating the playback of media excerpts.
 *
 * @class Angular.ImpulsePlaybackController
 */

angular.module('core').controller('ImpulsePlaybackController', [
    '$scope',
    'TrialData',
    '$timeout',
    'ExperimentManager',
    ...
    function($scope, TrialData, $timeout, ExperimentManager, $log, OSC) {
        ...
        $log.debug('Loading ImpulsePlaybackController.');
        ...
        /**
         * The `ImpulsePlaybackController`'s `$scope` object. All properties on
         * `$scope` are available to the view.
         *
         * @name $scope
         * @namespace
         * @instance
         * @memberof Angular.ImpulsePlaybackController
         * @type {{}}
         */
         ...
         * @memberof Angular.ImpulsePlaybackController#$scope
         * @instance
         * @type {string}
         */
         ...
         * Angular.ImpulsePlaybackController#$scope#buttonAction|$scope#buttonAction}
         * is bound to {@link Angular.ExperimentManager#advanceSlide|ExperimentManager#advanceSlide}.
         *
         * @function startImpulsePlayback
         * @memberof Angular.ImpulsePlaybackController#$scope
         * @instance
         * @return {undefined}
         */
        $scope.startImpulsePlayback = function() {
            ...
            $log.debug('Binding $scope.buttonAction in' +
                ' ImpulsePlaybackController to ExperimentManager.advanceSlide');
         ...
         * Angular.ImpulsePlaybackController#$scope#startImpulsePlayback|$scope#startImpulsePlayback}.
         *
         * @name buttonAction
         * @memberof Angular.ImpulsePlaybackController#$scope
         * @instance
         * @type {function}
         */
        $scope.buttonAction = $scope.startImpulsePlayback;
        ...
        $scope.$on('$destroy', function stopImpulsePlayback() {

            $log.debug('ImpulsePlaybackController scope destroyed. Stopping' +
         ...
         * Angular.ImpulsePlaybackController#$scope#currentButtonLabel|$scope#currentButtonLabel}
         *  is set to `'Continue'`, {@link
         *  Angular.ImpulsePlaybackController#$scope#mediaHasPlayed|$scope#mediaHasPlayed}
         *  is set to `true`, and {@link
         *  Angular.ImpulsePlaybackController#$scope#buttonDisabled|$scope#buttonDisabled}
         *  is set to `true`.
         *
